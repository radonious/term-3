...
// Constructors
    ...
    friend ostream& operator<<(ostream& os, const LoggerConsole& obj) {
    ...
    friend istream& operator>>(istream& os, LoggerConsole& obj) {
        char* line = new char[255];
        os >> line;
        obj.arr.push_back(line);
        return os;
    }
    ...
    friend class LoggerConsoleIterator;
private:
